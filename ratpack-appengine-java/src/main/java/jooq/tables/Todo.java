...
public class Todo extends TableImpl<TodoRecord> {
    ...
    private static final long serialVersionUID = -1568819994;
     ...
     */
    public final TableField<TodoRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_FF3670BF_DDB0_4EDE_985A_C158DD5CA9ED)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
