...
public class Todo extends TableImpl<TodoRecord> {
    ...
    private static final long serialVersionUID = -1535992030;
     ...
     */
    public final TableField<TodoRecord, Long> ID = createField("ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_4029C3D2_ECB2_4D5E_9CEA_D131879B130A)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
